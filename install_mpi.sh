...
echo "export PATH=$PATH:/opt/openmpi/3.1.2/bin" >> /users/jl866428/.bashrc
echo "export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/opt/openmpi/3.1.2/lib/" >> /users/jl866428/.bashrc
cd ..
